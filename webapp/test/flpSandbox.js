		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comnsdmsfioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnsdmsfioriapp-display": {
								"semanticObject": "comnsdmsfioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ns.dmsfioriapp",
									"url": sap.ui.require.toUrl("com/ns/dmsfioriapp")
								}
							}
						}
					}
